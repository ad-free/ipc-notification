...
from .models import APNS, GCM, WNS, WebPush
...
admin.site.register(APNS, DeviceAdmin)
admin.site.register(GCM, GCMDeviceAdmin)
admin.site.register(WNS, DeviceAdmin)
admin.site.register(WebPush, DeviceAdmin)

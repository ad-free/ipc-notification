...
class DatabaseWrapper(BaseDatabaseWrapper):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.mongolink_connection = None
    ...
    def get_new_connection(self, connection_params):
        ...
        self.mongolink_connection = MongolinkClient(database, es)
    ...
    def create_cursor(self, name=None):
        ...
        """
        return Cursor(self.client_connection, self.connection, self.mongolink_connection)
